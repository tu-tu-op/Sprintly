...
exports.DEVELOPER_SCORE_VERSION = void 0;
exports.calculateDeveloperScore = calculateDeveloperScore;
exports.deriveBadges = deriveBadges;
exports.DEVELOPER_SCORE_VERSION = 1;
/**
 ...
 */
function calculateDeveloperScore(aggregation) {
    const components = {
    ...
    const score = Math.round(components.focus * 0.2
    ...
    return { version: exports.DEVELOPER_SCORE_VERSION, score: clamp(score, 0, 100), components };
}
function deriveBadges(records, aggregation) {
...
function badge(id, label, description, progress, target) {
...
function averageRecords(records, selector) {
